...
credentagent.mount(store.app); // wires the /credentagent/* ceremony rails; payment completes through completeOrder → settle
...
console.log(`\n  ✓ CredentAgent storefront with x402 settlement → ${url}`);
