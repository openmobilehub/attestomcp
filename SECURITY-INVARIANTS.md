...
The contributor guardrail for [`@openmobilehub/attestomcp-gate`](../../packages/attestomcp-gate).
...
[`ceremony/completion.ts`](../../packages/attestomcp-gate/src/ceremony/completion.ts), is the
...
([`manifest.ts`](../../packages/attestomcp-gate/src/manifest.ts) /
[`types.ts`](../../packages/attestomcp-gate/src/types.ts)), so a host that can only enforce on
...
[`ceremony/credential-gate/credential-gate.test.ts`](../../packages/attestomcp-gate/src/ceremony/credential-gate/credential-gate.test.ts)
...
([`completion.ts`](../../packages/attestomcp-gate/src/ceremony/completion.ts)):
...
([`ceremony/credential-gate/routes.ts`](../../packages/attestomcp-gate/src/ceremony/credential-gate/routes.ts),
[`verify.ts`](../../packages/attestomcp-gate/src/ceremony/credential-gate/verify.ts)). Both
payment rails re-sum the cart lines in their Gate 1 and ignore the stored `payment.amount`
([`ceremony/mandate.ts`](../../packages/attestomcp-gate/src/ceremony/mandate.ts),
[`ceremony/dc-payment/verify.ts`](../../packages/attestomcp-gate/src/ceremony/dc-payment/verify.ts)).

**Bypass test.**
[`ceremony/mount.test.ts`](../../packages/attestomcp-gate/src/ceremony/mount.test.ts) — *"refuses
a tampered total (re-derived from the catalog, not the token)."* CT8 in
[`credential-gate.test.ts`](../../packages/attestomcp-gate/src/ceremony/credential-gate/credential-gate.test.ts)
...
[`ceremony/mandate.ts`](../../packages/attestomcp-gate/src/ceremony/mandate.ts)) and require it to
...
**Bypass test.** CT8 in
[`ceremony/dc-payment/dc-payment.test.ts`](../../packages/attestomcp-gate/src/ceremony/dc-payment/dc-payment.test.ts)
...
fallback ([`store.ts`](../../packages/attestomcp-gate/src/store.ts)):
...
**Bypass test.**
[`client.test.ts`](../../packages/attestomcp-gate/src/client.test.ts) — *"two clients keep
...
the requested threshold* ([`credentials.ts`](../../packages/attestomcp-gate/src/credentials.ts)):
...
([`ceremony/credential-gate/verify.ts`](../../packages/attestomcp-gate/src/ceremony/credential-gate/verify.ts)).
...
([`presentation.test.ts`](../../packages/attestomcp-gate/src/ceremony/credential-gate/presentation.test.ts))
and *"REFUSES a value-bypass: a decryptable token disclosing age_over_21=false does NOT pass"*
([`mdoc-iso.test.ts`](../../packages/attestomcp-gate/src/ceremony/mdoc/mdoc-iso.test.ts)).
...
- **WebAuthn (passkey rail).** The assertion is verified with `expectedOrigin` and
  ...
  ([`ceremony/passkey/verify.ts`](../../packages/attestomcp-gate/src/ceremony/passkey/verify.ts),
  [`ceremony/challengeToken.ts`](../../packages/attestomcp-gate/src/ceremony/challengeToken.ts)).
...
- **iOS `org-iso-mdoc`.** The `DeviceResponse` is HPKE-decrypted bound to the web origin via
  ...
  decrypt
  ([`ceremony/mdoc/`](../../packages/attestomcp-gate/src/ceremony/mdoc/)).

The origin / RP-ID is derived once from the request (honoring `x-forwarded-*` behind a
TLS-terminating proxy) in [`ceremony/origin.ts`](../../packages/attestomcp-gate/src/ceremony/origin.ts).
...
**Bypass test.**
[`ceremony/challengeToken.test.ts`](../../packages/attestomcp-gate/src/ceremony/challengeToken.test.ts)
...
[`ceremony/mdoc/mdoc-iso.test.ts`](../../packages/attestomcp-gate/src/ceremony/mdoc/mdoc-iso.test.ts)
