...
The contributor guardrail for [`@openmobilehub/credentagent-gate`](../../packages/credentagent-gate).
...
[CredentAgent SDK constitution](../../.specify/memory/constitution.md).
...
[`ceremony/completion.ts`](../../packages/credentagent-gate/src/ceremony/completion.ts), is the
...
([`manifest.ts`](../../packages/credentagent-gate/src/manifest.ts) /
[`types.ts`](../../packages/credentagent-gate/src/types.ts)), so a host that can only enforce on
...
[`ceremony/credential-gate/credential-gate.test.ts`](../../packages/credentagent-gate/src/ceremony/credential-gate/credential-gate.test.ts)
...
([`completion.ts`](../../packages/credentagent-gate/src/ceremony/completion.ts)):
...
([`ceremony/credential-gate/routes.ts`](../../packages/credentagent-gate/src/ceremony/credential-gate/routes.ts),
[`verify.ts`](../../packages/credentagent-gate/src/ceremony/credential-gate/verify.ts)). Both
payment rails re-sum the cart lines in their Gate 1 and ignore the stored `payment.amount`
([`ceremony/mandate.ts`](../../packages/credentagent-gate/src/ceremony/mandate.ts),
[`ceremony/dc-payment/verify.ts`](../../packages/credentagent-gate/src/ceremony/dc-payment/verify.ts)).

**Bypass test.**
[`ceremony/mount.test.ts`](../../packages/credentagent-gate/src/ceremony/mount.test.ts) — *"refuses
a tampered total (re-derived from the catalog, not the token)."* CT8 in
[`credential-gate.test.ts`](../../packages/credentagent-gate/src/ceremony/credential-gate/credential-gate.test.ts)
...
[`ceremony/mandate.ts`](../../packages/credentagent-gate/src/ceremony/mandate.ts)) and require it to
...
**Bypass test.** CT8 in
[`ceremony/dc-payment/dc-payment.test.ts`](../../packages/credentagent-gate/src/ceremony/dc-payment/dc-payment.test.ts)
...
fallback ([`store.ts`](../../packages/credentagent-gate/src/store.ts)):
...
([`routes.ts`](../../packages/credentagent-gate/src/ceremony/credential-gate/routes.ts),
[`completion.ts`](../../packages/credentagent-gate/src/ceremony/completion.ts)). Two `CredentAgent`
...
**Bypass test.**
[`client.test.ts`](../../packages/credentagent-gate/src/client.test.ts) — *"two clients keep
...
the requested threshold* ([`credentials.ts`](../../packages/credentagent-gate/src/credentials.ts)):
...
([`ceremony/credential-gate/verify.ts`](../../packages/credentagent-gate/src/ceremony/credential-gate/verify.ts)).
...
([`presentation.test.ts`](../../packages/credentagent-gate/src/ceremony/credential-gate/presentation.test.ts))
and *"REFUSES a value-bypass: a decryptable token disclosing age_over_21=false does NOT pass"*
([`mdoc-iso.test.ts`](../../packages/credentagent-gate/src/ceremony/mdoc/mdoc-iso.test.ts)).
...
- **WebAuthn (passkey rail).** The assertion is verified with `expectedOrigin` and
  ...
  ([`ceremony/passkey/verify.ts`](../../packages/credentagent-gate/src/ceremony/passkey/verify.ts),
  [`ceremony/challengeToken.ts`](../../packages/credentagent-gate/src/ceremony/challengeToken.ts)).
...
- **iOS `org-iso-mdoc`.** The `DeviceResponse` is HPKE-decrypted bound to the web origin via
  ...
  decrypt
  ([`ceremony/mdoc/`](../../packages/credentagent-gate/src/ceremony/mdoc/)).

The origin / RP-ID is derived once from the request (honoring `x-forwarded-*` behind a
TLS-terminating proxy) in [`ceremony/origin.ts`](../../packages/credentagent-gate/src/ceremony/origin.ts).
...
**Bypass test.**
[`ceremony/challengeToken.test.ts`](../../packages/credentagent-gate/src/ceremony/challengeToken.test.ts)
...
[`ceremony/mdoc/mdoc-iso.test.ts`](../../packages/credentagent-gate/src/ceremony/mdoc/mdoc-iso.test.ts)
